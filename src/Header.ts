export type HeaderSection = 'test' | 'library-notes' | 'test-app-notes'
...
export class Header {
  ...
  public render(): HTMLElement {
    ...
    navigation.append(
      ...
      this.createNavigationButton('library-notes', 'Library Notes'),
      this.createNavigationButton('test-app-notes', 'Test App Notes'),
    )
